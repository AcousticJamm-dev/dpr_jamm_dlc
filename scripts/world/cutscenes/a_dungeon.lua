return {
    ...
    superstar = function(cutscene, event)
		...
		cutscene:text("* I mean,[wait:5] I love breaking things,[wait:5] but...", "wtf_b", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* Yeah.[wait:10] Let's see what else we can find.", "nervous", "jamm")
		cutscene:hideNametag()
    end,
	
    breaktime = function(cutscene, event)
		local jamm = cutscene:getCharacter("jamm")
		local dess = cutscene:getCharacter("dess")
		...
		Assets.playSound("impact")
		cutscene:shakeCharacter(jamm, 2)
		cutscene:wait(1)
		
		cutscene:showNametag("Dess")
		cutscene:text("* u ok bro?", "wtf_b", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* Y-yeah,[wait:5] I'm fine...", "ouch", "jamm")
		cutscene:text("* That star run section took a lot out of me.", "ouch", "jamm")
		cutscene:text("* You mind if we take a break?", "nervous", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* sure i guess", "kind", "dess")
		cutscene:hideNametag()
		cutscene:resetSprite(jamm)
		
		cutscene:walkToSpeed(jamm, "jamm_walkto", 4, "down")
		cutscene:wait(cutscene:walkToSpeed(dess, "dess_walkto", 4, "right"))	-- y'all should probably make a sitting sprite for Dess lmao
		
		cutscene:setSprite(jamm, "talk_to_marcy")
		cutscene:wait(1)
		
		cutscene:showNametag("Jamm")
		cutscene:text("* That feels really good...", "happy", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* ...Hey,[wait:5] Jamm...", "neutral_b", "dess")
		cutscene:text("* Why did you bring us back here?", "neutral", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* Well,[wait:5] that observation trial made me curious...", "neutral", "jamm")
		cutscene:text("* I was sure that the door was closed,[wait:5] but...", "look_left", "jamm")
		cutscene:text("* I dunno.[wait:10]\n* It made me second guess.", "nervous", "jamm")
		cutscene:text("* I then became curious because,[wait:5] well...", "look_left", "jamm")
		cutscene:text("* You see a door open,[wait:5] you wonder what's there,[wait:5] right?", "neutral", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* so we're not in some king of dungeonkiller route?", "neutral_b", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* Dungeonkiller?", "suspicious", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* like before the reboot lol", "genuine", "dess")
		cutscene:text("* back when we had few rules", "neutral_b", "dess")
		cutscene:text("* when you seemed like you knew all of us from the start", "neutral", "dess")
		cutscene:text("* there was this route that...[wait:10] well...", "neutral", "dess")
		cutscene:text("* ok they made it seem like my fault for some reason", "genuine", "dess")
		cutscene:text("* but we did all the tasks wrong", "neutral", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* Dess,[wait:5] I seriously have no idea what you're talking about.", "suspicious", "jamm")
		cutscene:text("* Dungeonkiller route?[wait:10] Reboot?", "nervous", "jamm")
		cutscene:text("* As if anything like that would ever happen.", "smug", "jamm")
		cutscene:text("* ...", "neutral", "jamm")
		cutscene:text("* You okay?[wait:10]\n* You seemed off when talking about that.", "worried", "jamm")
		cutscene:text("* As if you were scared of...[wait:10] something.", "worried_down", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* i'm fine,[wait:5] actually.", "calm", "dess")
		cutscene:text("* I'm...[wait:10] fine...", "calm_b", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* If you say so...", "worried", "jamm")
		cutscene:text("* Maybe we should get back on track.", "relief", "jamm")
		cutscene:hideNametag()
		cutscene:resetSprite(jamm)
		...
		cutscene:text("* Dess,[wait:5] how are you doing that?", "nervous_left", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* reindeer can walk up steep cliffs lol", "condescending", "dess")
		cutscene:showNametag("Jamm")
		cutscene:text("* ...Isn't that goats?", "nervous", "jamm")
		cutscene:showNametag("Dess")
		cutscene:text("* does it look like it's goats?", "smug", "dess")
		cutscene:look(jamm, "down")
		cutscene:showNametag("Jamm")
		cutscene:text("* ...Okay then.", "nervous", "jamm")
		cutscene:hideNametag()
    end,
}
